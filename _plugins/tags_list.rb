module Jekyll
  ...
  module Tagslist
    ...
    class TagslistTag < Liquid::Tag
      ...
      def render(context)
        tags = context.registers[:site].tags.capitalize.map do |tag, posts|
        ...
        tags.each do |tag, count|
          ...
          html << "<a class=\"dropdown-item\" href=\"https:\/\/garanse.github.io/tag/#{tag.downcase.strip.gsub(' ', '-').gsub(/[^\w-]/, '')}\">#{tag.split.map(&:capitalize)*' '}</a>"
